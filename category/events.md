...
<p align="justify"> Are you a student (BSc, MSc, PhD) or a postdoc working with sed(a)DNA? Would you like to meet with peers, discuss methods, data interpretation, present your latest findings? The <b>ERCs seminar series</b> are monthly meetings where early career researchers (ECRs) can discuss about sedaDNA and ask questions in a non-formal setting. Since labs working on sedaDNA are found all around the globe, we have split up the meetings into two time zones (the Americas and Europe/Africa), each with a local coordinator. Meeting are usually on the first Thursday of every month. To be added to the mailing list, please fill in this <a href="https://docs.google.com/forms/d/1u33PJHJQJUXuyAedCrkgjgQLgKpq7y9M-VGLpCXxQGs/edit" target="_blank"><b>form</b></a>.
